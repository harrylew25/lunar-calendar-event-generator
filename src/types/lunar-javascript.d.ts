/**
 * Type definitions for lunar-javascript v1.7.x
 * Adapted from the official lunar-typescript definitions (same author/API).
 * @see https://github.com/6tail/lunar-javascript
 * @see https://6tail.cn/calendar/api.html
 */
